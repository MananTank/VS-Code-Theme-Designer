...
export const layout = {
	c10: {
		hex: '#15232d',
		info: ['title bar', 'side bar', 'status bar'],
	},
	c1: {
		hex: '#122738',
		info: ['activity bar', 'line number gutter', 'terminal'],
	},
	c9: {
		hex: '#193549',
		info: ['editor', 'inactive tabs', 'side bar group'],
	},
	c2: {
		hex: '#0d3a58',
		info: ['active file'],
	...
	c8: {
		hex: '#aaaaaa',
		info: ['secondary font color'],
	},
	c3: {
		hex: '#ffffff',
		info: ['primary font color', 'activity bar icons', 'various borders'],
	},
};
...
export const scopes = {
	...
	c7: {
		hex: '#ff9d00',
		info: ['if', 'else', 'operators + - = < > ..', 'import', 'export', 'css units cm px em ..', '!important', 'built in functions'],
	},
	c14: {
		hex: '#ff628c',
		info: ['constants', 'escape characters'],
	},
	c15: {
		hex: '#3ad900',
	...
	c18: {
		hex: '#9effff',
		info: ['function arguments', '& in css preprocessors', 'stylus variables'],
	},
	c19: {
		hex: '#e1efff',
		info: ['{ }', ': . ;', 'variable names'],
